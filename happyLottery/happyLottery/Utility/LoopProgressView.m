...
-(void)drawRect:(CGRect)rect
{
    ...
    label2 = [[UILabel alloc]initWithFrame:CGRectMake(0, label1.frame.size.height+5, weight, ViewWidth/6-3)];
    label2.center = CGPointMake(xCenter, yCenter + 10);
    label2.textAlignment = NSTextAlignmentCenter;
    label2.font = [UIFont boldSystemFontOfSize:fontNum];
    label2.textColor = self.color2 != nil ? self.color2 : RGB(51, 51, 51);
;
    label2.text = @"预测概率";
    ...
    arcLayer.strokeColor=[UIColor colorWithRed:49.0/255.0 green:137.0/255.0 blue:253.0/255.0 alpha:1].CGColor;
