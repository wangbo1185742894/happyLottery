...
@interface TouZhuViewController : BaseViewController <BetsListPopViewCellDelegate, UITableViewDataSource, UITableViewDelegate, LotteryManagerDelegate, UIPickerViewDelegate, UIPickerViewDataSource,BeitouViewDelegate,MemberManagerDelegate,ZhuiHaoViewControllerDelegate>
