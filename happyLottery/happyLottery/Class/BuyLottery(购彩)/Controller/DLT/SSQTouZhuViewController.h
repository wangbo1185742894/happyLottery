...
@interface SSQTouZhuViewController : BaseViewController <BetsListPopViewCellDelegate, UITableViewDataSource, UITableViewDelegate, LotteryManagerDelegate, UIPickerViewDelegate, UIPickerViewDataSource,MemberManagerDelegate>
